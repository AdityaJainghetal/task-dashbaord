...
import { FiEye, FiEdit2, FiTrash2, FiPlus, FiUsers, FiShoppingCart, FiTrendingUp } from 'react-icons/fi';
    ...
    try {
      ...
      if (response.ok) {
        ...
        setStats(prev => ({
          ...
          avgPagesPerUser: prev.totalPages > 1 ? 
            ((prev.totalPages - 1) / (typeof prev.activeUsers === 'number' ? prev.activeUsers : 1)).toFixed(1) : 0
        }));
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage all checkout pages and user data.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow flex items-start">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800 mt-1">{stats.totalPages}</p>
            </div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow flex items-start">
          ...
          <div className="bg-white p-6 rounded-lg shadow flex items-start">
            ...
            <div>
              <h3 className="text-gray-500 text-sm font-medium">Avg. Pages per User</h3>
              <p className="text-2xl font-bold text-gray-800 mt-1">{stats.avgPagesPerUser}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <h2 className="text-lg font-medium text-gray-800">All Checkout Pages</h2>
            <button 
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Form Fields</th>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div 
                          ...
                          style={{ backgroundColor: page.colors?.primary || '#4f46e5' }}
                        ></div>
