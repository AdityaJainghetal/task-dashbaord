...
//         setCheckout(response.data[0]); // use first if you expect only one
//       } catch (error) {
...
//         <h1 className="text-2xl font-bold text-gray-800">Checkout Page</h1>
//         <p className="text-gray-500">
//           Created: {new Date(checkout.createdAt).toLocaleDateString("en-GB")}
//         </p>
//       </div>
...
//             <span className="ml-2 text-gray-900">{checkout.productname}</span>
//           </p>
//           <p>
//             <span className="font-medium text-gray-700">Price:</span>
//             <span className="ml-2 text-gray-900">${checkout.productprice}</span>
//           </p>
//         </div>
//       </div>
...
//                 {checkout.owner.username}
//               </span>
//             </p>
//             <p>
//               <span className="font-medium text-gray-700">Role:</span>
//               <span className="ml-2 text-gray-900">{checkout.owner.role}</span>
//             </p>
//           </div>
//         </div>
//       )}
...
//     console.log("Preview clicked for", id);
//   };
...
//       <h1 className="text-2xl font-bold text-gray-800 mb-6">Your Checkout Pages</h1>
...
//             {/* Form Fields */}
//             <div className="mb-4">
//               <h3 className="text-lg font-semibold mb-2 text-gray-700">Form Fields</h3>
...
//               </button>
//               <button
//                 onClick={() => handleEdit(checkout._id)}
//                 className="px-4 py-2 bg-yellow-100 text-yellow-700 rounded-md hover:bg-yellow-200 transition-colors"
//               >
//                 Edit
//               </button>
...
//       font: checkout.font,
//       colors: {
//         primary: checkout.colors.primary,
//         secondary: checkout.colors.secondary
//       },
//       formFields: {
...
//                 <h2 className="text-xl font-bold text-gray-800">Edit Checkout Page</h2>
...
//                 <div>
//                   <label className="block text-gray-700 mb-1">Secondary Color</label>
//                   <div className="flex items-center">
//                     <input
//                       type="color"
...
//                 <div>
//                   <label className="block text-gray-700 mb-2">Form Fields</label>
//                   <div className="grid grid-cols-2 gap-2">
//                     <div className="flex items-center">
//                       <input
//                         type="checkbox"
          ...
          <div key={checkout._id} className="bg-white rounded-lg shadow-md p-6">
            {editingId === checkout._id ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border rounded"
                  />
                  {editFormData.product.image && (
                    <img 
                      src={editFormData.product.image} 
                      alt="Product preview" 
                ...
                <div>
                  <label className="block text-gray-700 mb-2">UTM Parameters</label>
                  <div className="space-y-2">
                    {Object.entries(editFormData.utmParameters).map(([param]) => (
                      <input
                        key={param}
                        type="text"
              ...
              <>
                ...
                <div className="mb-4">
                  <h3 className="text-lg font-semibold mb-2 text-gray-700">Product Info</h3>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="mb-2">
                      <span className="font-medium text-gray-700">Name:</span>
                      <span className="ml-2 text-gray-900">{checkout.product?.name || 'Not specified'}</span>
                    </p>
                    <p>
                      <span className="font-medium text-gray-700">Price:</span>
                      <span className="ml-2 text-gray-900">{checkout.product?.price || 'Not specified'}</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    {Object.entries(checkout.utmParameters || {}).map(([key, value]) => (
                      <p key={key} className="mb-2">
                        <span className="font-medium text-gray-700">{key}:</span>
                        <span className="ml-2 text-gray-900">{value || 'Not set'}</span>
                      </p>
                    ))}
                  </div>
                </div>
